...
PieceGenerator::PieceGenerator(const GameBox &gameBox_,int randomSeed) : random(randomSeed),gameBox(gameBox_),pieceId(0),prototypes{{
                                                                                                                                    Pos3d{-1,0,0}, //  ##
                                                                                                                                    Pos3d{0,0,0},  // ##
                                                                                                                                                 Pos3d{0,1,0}, Pos3d{1,1,0}},
                                                                                                                                    {
                                                                                                                                    Pos3d{-1,0,0}, // ####
                                                                                                                                    ...
                                                                                                                                    Pos3d{-1,0,0}, // ###
                                                                                                                                    Pos3d{0,0,0},  //   #
                                                                                                                                                 Pos3d{1,0,0}, Pos3d{1,1,0}},
                                                                                                                                    {
                                                                                                                                    Pos3d{-1,0,0}, // ###
                                                                                                                                    Pos3d{0,0,0},  //  #
                                                                                                                                                 Pos3d{1,0,0}, Pos3d{0,1,0}},
                                                                                                                                    {
                                                                                                                                    Pos3d{0,0,0}, // ##
                                                                                                                                    Pos3d{0,1,0},  // ##
                                                                                                                                                 Pos3d{1,0,0}, Pos3d{1,1,0}},
                                                                                                                                    ...
                                                                                                                                    Pos3d{-1,0,0}, // ##
                                                                                                                                    Pos3d{0,0,0},  //  o
                                                                                                                                                 Pos3d{0,1,1}, Pos3d{0,1,0}},
                                                                                                                                    {
                                                                                                                                    Pos3d{-1,0,0}, // o#
                                                                                                                                    Pos3d{0,0,0},  //  #
                                                                                                                                                 Pos3d{-1,0,1},Pos3d{0,1,0}},
                                                                                                                                    {
                                                                                                                                    Pos3d{0,0,0}, // o#
                                                                                                                                    Pos3d{1,0,0}, // #
                                                                                                                                                 Pos3d{0,1,0}, Pos3d{0,0,1}},
}{}
Piece PieceGenerator::nextPiece(){
std::uniform_int_distribution<> dist(0,prototypes.size()-1);
return randomTransformation(piece_generator::prototypeToPiece(prototypes[dist(random)],pieceId++).translated(Pos3d{
gameBox.dims.x/2,gameBox.dims.y/2,gameBox.dims.z+5
}));
}
